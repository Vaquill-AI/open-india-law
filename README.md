...
|---|---:|---:|---|
| [Central Administrative Tribunal (case information system) (CAT CIS)](scripts/tribunals/cat-cis-scraper.ts) | 181,429 | not measurable | 2021 to 2025 |
| [Central Administrative Tribunal (CAT)](scripts/tribunals/cat-scraper.ts) | 162,439 | 65,599 | 1985 to 2023 |
| [Customs, Excise and Service Tax Appellate Tribunal (CESTAT)](scripts/tribunals/cestat-scraper.ts) | 122,612 | 53,949 | 2000 to 2025 |
| [Income Tax Appellate Tribunal (ITAT)](scripts/tribunals/itat-scraper.ts) | 115,074 | 113,216 | 2021 to 2026 |
| [Debts Recovery Tribunal and Appellate Tribunal (DRT)](scripts/tribunals/drt-scraper.ts) | 108,395 | 75,130 | 2000 to 2026 |
| [National Company Law Tribunal (NCLT)](scripts/tribunals/nclt-efiling-scraper.ts) | 63,487 | 15,222 | 1996 to 2026 |
| [National Green Tribunal (NGT)](scripts/tribunals/ngt-scraper.ts) | 34,350 | 12,366 | 2011 to 2026 |
| [Securities Appellate Tribunal (SAT)](scripts/tribunals/sat-scraper.ts) | 9,296 | 3,653 | 2006 to 2026 |
| [Appellate Tribunal for Forfeited Property (ATFP)](scripts/tribunals/atfp-scraper.ts) | 3,359 | 2,956 | 2016 to 2026 |
| [Competition Commission of India (CCI)](scripts/tribunals/cci-scraper.ts) | 2,944 | 1,295 | 2010 to 2026 |
| [Appellate Tribunal for Electricity (APTEL)](scripts/tribunals/aptel-scraper.ts) | 2,707 | 2,328 | 2008 to 2026 |
| [GST Authority for Advance Ruling (GST AAR)](scripts/tribunals/gst-aar-scraper.ts) | 2,618 | 961 | 2017 to 2025 |
| [Insolvency and Bankruptcy Board of India (IBBI)](scripts/tribunals/ibbi-orders-scraper.ts) | 1,580 | 853 | 2017 to 2026 |
| [Real Estate Regulatory Authority (RERA)](scripts/tribunals/rera-maharera-scraper.ts) | 1,530 | not measurable | 2018 to 2026 |
| [Telecom Disputes Settlement and Appellate Tribunal (TDSAT)](scripts/tribunals/tdsat-judgment-scraper.ts) | 1,348 | 988 | 2001 to 2026 |
...
[scripts/tribunals/](scripts/tribunals/), with per-forum schema in
[scripts/tribunals/schema/](scripts/tribunals/schema/).
...
|---|---:|---:|
| [Ministry of Corporate Affairs (MCA)](scripts/regulators/mca-scraper.ts) | 2,666 | 46,480 |
| [Reserve Bank of India (RBI)](scripts/regulators/rbi-comprehensive-scraper.ts) | 2,640 | 104,143 |
| [Ministry of Environment, Forest and Climate Change (MOEFCC)](scripts/regulators/moefcc-scraper.ts) | 1,399 | 116,227 |
| [Directorate General of Foreign Trade (DGFT)](scripts/regulators/dgft-scraper.ts) | 1,233 | 4,252 |
| [Securities and Exchange Board of India (SEBI)](scripts/regulators/sebi-scraper.ts) | 1,144 | 88,310 |
| [Telecom Regulatory Authority of India (TRAI)](scripts/regulators/trai-scraper.ts) | 834 | 22,720 |
| [Central Pollution Control Board (CPCB)](scripts/regulators/cpcb-scraper.ts) | 558 | 13,752 |
| [Ministry of Law and Justice (LAW)](scripts/regulators/law-commission-scraper.ts) | 558 | 77,209 |
| State GST and tax authorities (TRIB) | 354 | 41,708 |
| [Insurance Regulatory and Development Authority of India (IRDAI)](scripts/regulators/irdai-scraper.ts) | 314 | 16,238 |
| [Department of Financial Services (DFS)](scripts/regulators/dfs-scraper.ts) | 283 | 18,509 |
...
Scrapers: [Acts crawler](scripts/legislation/indiacode-scraper.ts) ·
[HTML section extractor](scripts/legislation/indiacode-html-extractor.ts) ·
[repealed Acts](scripts/legislation/indiacode-download-repealed.py) ·
[gap re-scrape](scripts/legislation/indiacode-rescrape-missing.py) ·
[amendment metadata](scripts/legislation/indiacode-link-metadata.py) ·
[normalization pipeline](scripts/legislation/pipeline/run-pipeline.py)
...
| Stage | Script |
|---|---|
| PDF to markdown (text layer) | [pymupdf4llm_parser.py](scripts/pipeline/pymupdf4llm_parser.py) |
| Unified parser across document kinds | [unified_legal_parser.py](scripts/pipeline/unified_legal_parser.py) |
| Section boundary detection | [legal_section_detector.py](scripts/pipeline/legal_section_detector.py), [v2](scripts/pipeline/legal_section_detector_v2.py) |
| Section-aware chunking | [legal_chunker.py](scripts/pipeline/legal_chunker.py) |
| Metadata extraction | [metadata_extractor_v3.py](scripts/pipeline/metadata_extractor_v3.py) |
| Parallel chunking driver | [run-chunking-parallel.py](scripts/pipeline/run-chunking-parallel.py), [full pipeline](scripts/pipeline/run-pipeline-pymupdf4llm.py) |
| OCR fallback (no text layer) | [ocr-mistral.py](scripts/legislation/pipeline/ocr-mistral.py) |
| Chunk schema | [UNIFIED_CHUNKING_SCHEMA.md](scripts/pipeline/UNIFIED_CHUNKING_SCHEMA.md) |
| Read AWS Open Data HC parquet | [aws-hc-parquet-reader.py](scripts/pipeline/aws-hc-parquet-reader.py) |
...
Particularly useful right now: **verified copyright/terms pages for the forums marked `unverified` in [`coverage.yml`](coverage.yml)**, captured from an Indian IP.
...
`unknown` in [coverage.yml](coverage.yml), captured from an Indian IP. Most are unreachable
